...
# Module caffe2.python.examples.alexnet_trainer
...
'''
Parallelized multi-GPU distributed trainer for Alexnet. Can be used to train
...
logging.basicConfig()
log = logging.getLogger("alexnet_trainer")
...
def Train(args):
    ...
    train_model = model_helper.ModelHelper(
        name="alexnet", arg_scope=train_arg_scope
    )
    ...
    def create_alexnet_model_ops(model, loss_scale):
    ...
    if (args.test_data is not None):
        ...
        test_model = model_helper.ModelHelper(
            name="alexnet_test", arg_scope=test_arg_scope, init_params=False
        )
    ...
    expname = "alexnet_gpu%d_b%d_L%d_lr%.2f_v2" % (
        args.num_gpus,
        total_batch_size,
        args.num_labels,
        args.base_learning_rate,
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Caffe2: Alexnet training"
    )
    ...
    parser.add_argument("--save_model_name", type=str, default="alexnet_model",
